...
// Inicializa a variável $fornecedores como um array vazio.
...
try {
    ...
    $stmt->execute(); 
    // Busca todos os resultados da consulta e os armazena no array $fornecedores como um array associativo.
...
<head>
    ...
    function confirmDeletion() {
        return confirm('Tem certeza que deseja deletar este fornecedor?'); // Alerta de confirmação.
    }
    </script>
...
<body>
    ...
    <div class="botoes-linha">
        <a href="exportar_excel.php?tipo=fornecedor" target="_blank" class="botao-link">Exportar Fornecedores</a>
        <a href="cadastrar_fornecedores.php" class="botao-link">Cadastrar Novo Fornecedor</a>
